...
#ifndef VIDEO_PLAYER_PIP_SWIFT_H
#define VIDEO_PLAYER_PIP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="video_player_pip",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16video_player_pip20VideoPlayerPipPlugin")
@interface VideoPlayerPipPlugin : NSObject <AVPictureInPictureControllerDelegate, FlutterPlugin>
